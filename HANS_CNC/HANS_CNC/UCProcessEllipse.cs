...
namespace HANS_CNC
{
    public partial class UCProcessEllipse : UserControl
    {
        ...
        private Color m_valueColor = Color.ForestGreen;//Color.FromArgb(255, 77, 59);
        ...
        private Font m_font = new Font("Arial Unicode MS", 18);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (m_showType == HANS_CNC.ShowType.Ring)
            {
                //中心圆
                ...
                if (m_value > 0 && m_maxValue > 0)
                {
                    ...
                    string strValueText = m_valueType == HANS_CNC.ValueType.Percent ? fltPercent.ToString("0%") : m_value.ToString();
